...
create table usrlist(usr_id varchar(35) primary key,flag varchar(30),temp varchar(30),usr_name varchar(40));
...
insert into usrlist values("testusr001",'plane',null,'テストユーザー001');
insert into qs_gplist values("testgp1","0,30 * * * * *",null,"password","U3aa127f38f35ddee3962757fe0d50eba");
insert into qs_gplist values("testgp2","0,30 * * * * *",null,"password","U3aa127f38f35ddee3962757fe0d50eba");
insert into qs_gplist values("testgp3","0,30 * * * * *",null,"password","U3aa127f38f35ddee3962757fe0d50eba");
...
insert into qs_list values("test003","testgp3","0,30 * * * * *",cast('2020-12-16 21:00:00.000000' as datetime),false);
